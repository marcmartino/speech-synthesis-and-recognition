...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var esSpeak, enSpeak, esListen, enListen;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    return [4 /*yield*/, voices.isReady];
                case 1:
                    _a.sent();
                    esSpeak = synthesisSpeak_1.speak(voices.randVoiceFunc(voices.getVoicesByFilter({ lang: 'es' })));
                    enSpeak = synthesisSpeak_1.speak(voices.randVoiceFunc(voices.getVoicesByFilter({ lang: "en" })));
                    esListen = speechRecognition_1.listenForWords("es-US");
                    enListen = speechRecognition_1.listenForWords("en-US");
                    esSpeak('Hola!')().then(enSpeak("Okay, what's next?")).then(enSpeak('complete')).catch(console.log);
                    return [2 /*return*/];
            }
        });
    });
...
Object.defineProperty(exports, "__esModule", { value: true });
var languageTools_1 = __webpack_require__(4);
...
var listenFor = function listenFor(lang) {
    if (lang === void 0) {
        lang = 'en-US';
    }
    return function (grammars) {
        return function (expected) {
            return listen(lang)(grammars)(isRecognizedWordInList(expected));
        };
    };
};
exports.listenFor = listenFor;
var listenForWords = function listenForWords(lang) {
    return function (expectedWords) {
        return listenFor(lang)([wordListToGrammar(expectedWords)])(expectedWords);
    };
};
exports.listenForWords = listenForWords;
var wordListToGrammar = function wordListToGrammar(words) {
    return "#JSGF V1.0;grammar Generic;public <Generic> = <generic>;<generic> = ( " + words.join(' | ') + " );";
};
//TODO: should be lowercasing here
var isRecognizedWordInList = function isRecognizedWordInList(words) {
    return function (e) {
        return lodash_1.indexOf(words.map(languageTools_1.removeAccents), languageTools_1.removeAccents(e.results[0][0].transcript)) >= 0;
    };
};
